...
const nest_shrimpy_client_module_1 = require("./nest-shrimpy-client/nest-shrimpy-client.module");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        const app = yield core_1.NestFactory.create(nest_shrimpy_client_module_1.NestShrimpyClientModule);
